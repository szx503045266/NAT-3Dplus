...
from natformer.natten import NeighborhoodAttention_3D_GlobalT_RmDup, NeighborhoodAttention_3D_GlobalT_ConcentrateContx_RmDup
...
class NATLayer(nn.Module):
    def __init__(self, dim, num_heads, kernel_size=7,
        ...
        if down_spat > 1:
            self.attn = NeighborhoodAttention_3D_GlobalT_ConcentrateContx_RmDup(
