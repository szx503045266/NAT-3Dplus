...
from natformer.natten import NeighborhoodAttention_3D_GlobalT2_RmDup, NeighborhoodAttention_3D_GlobalT2_CondenseContext_RmDup
...
class NATLayer(nn.Module):
    def __init__(self, dim, num_heads, kernel_size=7,
        ...
        if down_spat > 0:  ###1
            self.attn = NeighborhoodAttention_3D_GlobalT2_CondenseContext_RmDup(
            ...
            self.attn = NeighborhoodAttention_3D_GlobalT2_RmDup(
                dim, kernel_size=kernel_size, num_heads=num_heads,
