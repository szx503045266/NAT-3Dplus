...
from natformer.natten import NeighborhoodAttention_3D_GlobalT_RmDup_SE3, NeighborhoodAttention_3D_GlobalT_CondenseContext_RmDup_SE3
...
class NATLayer(nn.Module):
    def __init__(self, dim, num_heads, kernel_size=7,
        ...
        if down_spat > 0:  ###1
            self.attn = NeighborhoodAttention_3D_GlobalT_CondenseContext_RmDup_SE3(
            ...
            self.attn = NeighborhoodAttention_3D_GlobalT_RmDup_SE3(
                dim, kernel_size=kernel_size, num_heads=num_heads,
