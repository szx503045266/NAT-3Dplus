...
from natformer.natten import NeighborhoodAttention_3D_GlobalT, NeighborhoodAttention_Dilated3D_hybrid_GlobalT
...
class NATLayer(nn.Module):
    def __init__(self, dim, num_heads, kernel_size=7,
        ...
        if dilated_step > 0:
            self.attn = NeighborhoodAttention_Dilated3D_hybrid_GlobalT(
            ...
            self.attn = NeighborhoodAttention_3D_GlobalT(
                dim, kernel_size=kernel_size, num_heads=num_heads,
