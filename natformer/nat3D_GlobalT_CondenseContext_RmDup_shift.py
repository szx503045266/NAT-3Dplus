...
from natformer.natten import NeighborhoodAttention_3D_GlobalT_RmDup_shift, NeighborhoodAttention_3D_GlobalT_CondenseContext_RmDup_shift
...
class NATLayer(nn.Module):
    def __init__(self, dim, num_heads, kernel_size=7,
        ...
        if down_spat > 0:  ###1
            self.attn = NeighborhoodAttention_3D_GlobalT_CondenseContext_RmDup_shift(
            ...
            self.attn = NeighborhoodAttention_3D_GlobalT_RmDup_shift(
                dim, kernel_size=kernel_size, num_heads=num_heads,
