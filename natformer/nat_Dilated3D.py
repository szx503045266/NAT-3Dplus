...
from natformer.natten import NeighborhoodAttention_3D, NeighborhoodAttention_Dilated3D
...
class NATLayer(nn.Module):
    def __init__(self, dim, num_heads, kernel_size=7,
        ...
        if dilated_step > 0:
            self.attn = NeighborhoodAttention_Dilated3D(
    ...
    def __init__(self, dim, depth, num_heads, kernel_size, downsample=True,
        ...
        self.blocks = nn.ModuleList([
            NATLayer(dim=dim,
                     ...
                     norm_layer=norm_layer, layer_scale=layer_scale, n_seg=self.n_seg, dilated_step=(i%2)*dilated_step)
