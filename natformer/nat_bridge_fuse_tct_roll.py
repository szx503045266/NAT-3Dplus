...
from natformer.natten import NeighborhoodAttention_bridge_fuse_tct_roll, NeighborhoodAttention_bridge_q_fuse_tct_roll
...
class NATLayer(nn.Module):
    def __init__(self, dim, num_heads, kernel_size=7,
        ...
        self.attn = NeighborhoodAttention_bridge_fuse_tct_roll(
