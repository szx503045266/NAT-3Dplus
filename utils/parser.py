...
def get_store_name(cfg):
	...
	if cfg.MODEL.NET in ["nat3D_GlobalT_DownSpat_RmDup", "nat3D_GlobalT_ConcentrateContx_RmDup", "nat3D_GlobalT_CondenseContext_RmDup", "nat3D_GlobalT_CondenseContext_RmDup_SE", "nat3D_GlobalT_CondenseContext_RmDup_SE3"]:
		s2 = "_".join(str(e) for e in cfg.MODEL.NeAT3DPlus_DOWN_SPAT)
		store_name = store_name + "_DownSpat_{}".format(
		s2,
	)
	return store_name
